...
//#include <stdlib.h>
//#include <string.h>
//char color[8][2] = { { "白" }, { "黑" }, { "红" }, { "蓝" }, { "黄" }, { "绿" }, { "橙" }, { "褐" } };
///*--- 生成4个不同数字的组合并存入数组x ---*/
...
//	int no[4];			/* 要猜的数字串 */
//	char buff[10];
//	char gagaga[100];/* 用于存放读取的数字串的字符串 */
